...
source("NimbleModel 2species Softcore.R")
source("Nimble Functions 2species Softcore.R") #nimble functions used in data simulator
...
parameters <- c('p01','D.beta11','sigma1','N1','D01','lambda1',
              'p02','D.beta12','omega','sigma2','N2','D02','lambda2')
...
conf$addSampler(target = c("D02","D.beta12",'omega'),
                type = 'AF_slice',control=list(adaptive=TRUE),silent = TRUE)
